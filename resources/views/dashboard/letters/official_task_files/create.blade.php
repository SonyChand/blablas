<x-dash.layout>
    @slot('title')
        {{ $title }}
    @endslot
    <h2 class="mb-4">Tambah Official Task File</h2>
    <div class="row">
        <div class="col-xl-6">
            <form class="row g-3 mb-6 needs-validation" novalidate="" method="POST"
                action="{{ route('official-task-files.store') }}" onsubmit="showLoader()" enctype="multipart/form-data">
                @csrf
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="letter_type" type="text" name="letter_type"
                            placeholder="Jenis Surat" value="{{ old('letter_type') }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="letter_reference" type="text" name="letter_reference"
                            placeholder="Referensi Surat" value="{{ old('letter_reference') }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="assign" name="assign" placeholder="Penugasan" required style="height: 100px">{{ old('assign') }}</textarea>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="to_implement" name="to_implement" placeholder="Pelaksanaan" required
                            style="height: 100px">{{ old('to_implement') }}</textarea>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="letter_closing" name="letter_closing" placeholder="Penutup Surat" required
                            style="height: 100px">{{ old('letter_closing') }}</textarea>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="letter_creation_date" type="date" name="letter_creation_date"
                            value="{{ old('letter_creation_date') }}" required />
