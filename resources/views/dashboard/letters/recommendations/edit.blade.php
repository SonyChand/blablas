<x-dash.layout>
    @slot('title')
        {{ $title }}
    @endslot
    <h2 class="mb-4">Edit Rekomendasi</h2>
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6 needs-validation" novalidate="" method="POST"
                action="{{ route('recommendation-letters.update', $recommendation->id) }}" onsubmit="showLoader(event)">
                @csrf
                @method('PUT')
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="recommendation_type" type="text" name="recommendation_type"
                            placeholder="Jenis Rekomendasi"
                            value="{{ old('recommendation_type', $recommendation->recommendation_type) }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="recommendation_number" type="text"
                            ...
                            value="{{ old('recommendation_number', $recommendation->recommendation_number) }}"
                            required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="basis_of_recommendation" type="text"
                            ...
                            value="{{ old('basis_of_recommendation', $recommendation->basis_of_recommendation) }}"
                            required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="recommendation_consideration" type="text"
                            ...
                            value="{{ old('recommendation_consideration', $recommendation->recommendation_consideration) }}"
                            required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="recommended_data" name="recommended_data" placeholder="Data yang Direkomendasikan"
                            required>{{ old('recommended_data', $recommendation->recommended_data) }}</textarea>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="recommendation_purpose" type="text"
                            ...
                            value="{{ old('recommendation_purpose', $recommendation->recommendation_purpose) }}"
                            required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="recommendation_closing" name="recommendation_closing"
                            placeholder="Penutup Rekomendasi" required>{{ old('recommendation_closing', $recommendation->recommendation_closing) }}</textarea>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="recommendation_date" type="date" name="recommendation_date"
                            value="{{ old('recommendation_date', $recommendation->recommendation_date->format('Y-m-d')) }}"
                            required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="signed_by" type="text" name="signed_by"
                            ...
                            value="{{ old('signed_by', $recommendation->signed_by) }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="operator_name" type="text" name="operator_name"
                            ...
                            value="{{ old('operator_name', $recommendation->operator_name) }}" required />
