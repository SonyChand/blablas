                    ...
                    <table class="table fs-9 mb-0 border-top border-translucent">
                        <thead>
                            <tr>
                                ...
                                <th class="sort white-space-nowrap  ps-0" scope="col" data-sort="file">File
                                </th>
                        ...
                        <tbody class="list" id="project-list-table-body">
                            ...
                            @foreach ($letters as $row)
                                <tr class="position-static">
                                    ...
                                    <td class=" time white-space-nowrap ps-0 whatsapp py-4">
                                        {{ \Carbon\Carbon::parse($row->letter_date)->format('d F Y') }}</td>
                                    <td class=" time white-space-nowrap ps-0 whatsapp py-4">
                                        {{ $row->subject }}</td>
                                    <td class=" time white-space-nowrap ps-0 whatsapp py-4">
                                        {{ ucwords(str_replace('_', ' ', $row->attachment)) }}</td>
                                    <td class=" time white-space-nowrap ps-0 whatsapp py-4">
                                        {{ is_array($row->file_path) ? count($row->file_path) : 0 }} file
                                    </td>
                                    <td class=" time white-space-nowrap ps-0 whatsapp py-4">
