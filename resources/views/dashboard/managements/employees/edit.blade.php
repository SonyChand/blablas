<x-dash.layout>
    ...
    <div class="row">
            ...
            <form class="row g-3 mb-6 needs-validation" novalidate="" method="POST"
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating">
                        <select class="form-select @error('employee_type') is-invalid @enderror" id="employee_type"
                            ...
                            <option value="PNS"
                                {{ old('employee_type', $employee->employee_type) == 'PNS' ? 'selected' : '' }}>PNS
                            </option>
                            <option value="PPPK"
                                {{ old('employee_type', $employee->employee_type) == 'PPPK' ? 'selected' : '' }}>PPPK
                            </option>
                        </select>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating">
                        <input class="form-control @error('rank_start_date') is-invalid @enderror" id="rank_start_date"
                            ...
                            value="{{ old('rank_start_date', $employee->rank_start_date->format('Y-m-d')) }}"
                            required />
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating form-floating-advance-select">
                        <label for="floaTingLabelSingleSelect">Pilih Pangkat/Golongan</label>
                        <select class="form-select" id="floaTingLabelSingleSelect" data-choices="data-choices"
                            data-options='{"removeItemButton":true,"placeholder":true}' name="rank" id="rank"
                            required>
                            ...
                            @foreach (['Pembina Utama - IV/e', 'Pembina Utama Madya - IV/d', 'Pembina Utama Muda - IV/c', 'Pembina Tk. I - IV/b', 'Pembina - IV/a', 'Penata Tk. I - III/d', 'Penata - III/c', 'Penata Muda Tk. I - III/b', 'Penata Muda - III/a', 'Pengatur Tk. I - II/d', 'Pengatur - II/c', 'Pengatur Muda Tk. I - II/b', 'Pengatur Muda - II/a', 'Juru Tk. I - I/d', 'Juru - I/c', 'Juru Muda Tk. I - I/b', 'Juru Muda - I/a'] as $rank)
                                <option value="{{ $rank }}"
                                    {{ old('rank', $employee->rank) == $rank ? 'selected' : '' }}>
                                    {{ $rank }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating">
                        <input class="form-control @error('position_start_date') is-invalid @enderror"
                            ...
                            value="{{ old('position_start_date', $employee->position_start_date->format('Y-m-d')) }}"
                            required />
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating">
                        <input class="form-control @error('major') is-invalid @enderror" id="major"
                            type="text" name="major" placeholder="Jurusan"
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating">
                        <input class="form-control @error('graduation_date') is-invalid @enderror"
                            ...
                            value="{{ old('graduation_date', optional($employee->graduation_date)->format('Y-m-d')) }}" />
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating form-floating-advance-select mb-3">
                        <label for="floaTingLabelSingleSelect">Pilih Unit Kerja</label>
                        <select class="form-select" id="floaTingLabelSingleSelect" data-choices="data-choices"
        ...
        'UPTD PUSKESMAS TAMBAKSARI',
                                ...
                                <option value="{{ $work_unit }}"
                                    {{ old('work_unit', $employee->work_unit) == $work_unit ? 'selected' : '' }}>
                                    {{ $work_unit }}</option>
                            @endforeach
                        </select>
                    </div>
