    ...
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6 needs-validation" novalidate="" method="POST"
                action="{{ route('spm.update', $spm->id) }}" onsubmit="showLoader(event)">
                @csrf
                @method('PUT')
                        ...
                        <select class="form-select @error('puskesmas_id') is-invalid @enderror" id="puskesmas_id"
                            ...
                            @foreach ($puskesmas as $puskesmasItem)
                                <option value="{{ $puskesmasItem->id }}"
                                    {{ old('puskesmas_id', $spm->puskesmas_id) == $puskesmasItem->id ? 'selected' : '' }}>
                                    {{ $puskesmasItem->nama }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select class="form-select @error('sub_layanan_id') is-invalid @enderror" id="sub_layanan_id"
                            ...
                            @foreach ($subLayanans as $subLayananItem)
                                <option value="{{ $subLayananItem->id }}"
                                    {{ old('sub_layanan_id', $spm->sub_layanan_id) == $subLayananItem->id ? 'selected' : '' }}>
                                    {{ $subLayananItem->nama }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select class="form-select @error('tahun_id') is-invalid @enderror" id="tahun_id"
                            ...
                            @foreach ($tahuns as $tahunItem)
                                <option value="{{ $tahunItem->id }}"
                                    {{ old('tahun_id', $spm->tahun_id) == $tahunItem->id ? 'selected' : '' }}>
                                    {{ $tahunItem->tahun }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('dilayani') is-invalid @enderror" id="dilayani"
                            type="number" name="dilayani" placeholder="Dilayani"
                            value="{{ old('dilayani', $spm->dilayani) }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('terlayani') is-invalid @enderror" id="terlayani"
                            type="number" name="terlayani" placeholder="Terlayani"
                            value="{{ old('terlayani', $spm->terlayani) }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('belum_terlayani') is-invalid @enderror" id="belum_terlayani"
                            type="number" name="belum_terlayani" placeholder="Belum Terlayani"
                            value="{{ old('belum_terlayani', $spm->belum_terlayani) }}" required />
                        <label for="belum_terlayani">Belum Terlayani</label>
                        @error('belum_terlayani')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('pencapaian') is-invalid @enderror" id="pencapaian"
                            type="number" step="0.01" name="pencapaian" placeholder="Pencapaian"
                            value="{{ old('pencapaian', $spm->pencapaian) }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('bulan') is-invalid @enderror" id="bulan" type="number"
                            name="bulan" placeholder="Bulan" value="{{ old('bulan', $spm->bulan) }}" required />
