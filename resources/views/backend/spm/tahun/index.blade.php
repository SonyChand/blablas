<x-dash.layout>
    ...
    <div class="mb-9">
        <div id="masterSummary" data-list='{"valueNames":["id", "tahun"],"page":10,"pagination":true}'>
                ...
                <div class="col-12 col-sm-auto">
                    <div class="d-flex align-items-center">
                        @can('master-spm-create')
                            <div class="mt-3 mx-2">
                                <a class="btn btn-primary btn-sm" href="{{ route('master-spm-tahun.create') }}">
                ...
                <table class="table fs-9 mb-0 border-top border-translucent">
                    <thead>
                        <tr>
                            ...
                            <th class="sort white-space-nowrap ps-0" scope="col" data-sort="tahun">Tahun</th>
                            @canany(['tahun-edit', 'tahun-delete'])
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end py-2">
                                                @can('master-spm-edit')
                                                    <a class="dropdown-item"
                                                        href="{{ route('master-spm-tahun.edit', $row->id) }}">Edit</a>
                                                @endcan
                                                @can('master-spm-delete')
                                                    <div class="dropdown-divider"></div>
                                                    <form method="POST"
                                                        action="{{ route('master-spm-tahun.destroy', $row->id) }}"
