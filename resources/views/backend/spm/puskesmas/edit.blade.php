    ...
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6 needs-validation" novalidate="" method="POST"
                action="{{ route('master-spm-puskesmas.update', $puskesmas->id) }}" onsubmit="showLoader(event)">
                @csrf
                @method('PUT')
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('kode') is-invalid @enderror" id="kode" type="text"
                            name="kode" placeholder="Kode" value="{{ old('kode', $puskesmas->kode) }}" />
                        <label for="kode">Kode Puskesmas</label>
                        @error('kode')
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('nama') is-invalid @enderror" id="nama" type="text"
                            name="nama" placeholder="Nama" value="{{ old('nama', $puskesmas->nama) }}" required />
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control @error('alamat') is-invalid @enderror" id="alamat" type="text"
                            name="alamat" placeholder="Alamat" value="{{ old('alamat', $puskesmas->alamat) }}"
                            required />
