<x-dash.layout>
    ...
    <div class="mb-9">
        <div id="masterSummary" data-list='{"valueNames":["id", "nama", "alamat"],"page":10,"pagination":true}'>
                ...
                <table class="table fs-9 mb-0 border-top border-translucent">
                    <thead>
                        <tr>
                            ...
                            <th class="sort white-space-nowrap ps-0" scope="col" data-sort="nama">Nama Puskesmas</th>
                            <th class="sort white-space-nowrap ps-0" scope="col" data-sort="alamat">Alamat</th>
