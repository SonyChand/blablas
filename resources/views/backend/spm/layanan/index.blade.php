<x-dash.layout>
    ...
    <div class="mb-9">
        <div id="masterSummary"
            data-list='{"valueNames":["id","kode", "nama", "persentase"],"page":10,"pagination":true}'>
                ...
                <table class="table fs-9 mb-0 border-top border-translucent">
                    <thead>
                        <tr>
                            ...
                            <th class="sort white-space-nowrap ps-0" scope="col" data-sort="kode">Kode</th>
                            <th class="sort white-space-nowrap ps-0" scope="col" data-sort="nama">Nama Layanan</th>
                            <th class="sort white-space-nowrap ps-0" scope="col" data-sort="persentase">Persentase
                            </th>
