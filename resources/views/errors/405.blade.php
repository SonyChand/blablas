                    ...
                    <div class="row justify-content-center align-items-center g-5 text-center">
                        <div class="col-12" style="font-family: “Brush Script MT”, cursive;">
                            <h1 class="display-1 fw-bold text-primary"
                                ...
                                405</h1>
                            <h2 class="text-body-secondary fw-bolder mb-3">Metode Tidak Diizinkan!</h2>
                            <p class="text-body mb-5">Metode yang digunakan dalam permintaan tidak diizinkan untuk
                                sumber daya ini.</p>
                            @php
