                    ...
                    <div class="row justify-content-center align-items-center g-5 text-center">
                        <div class="col-12" style="font-family: “Brush Script MT”, cursive;">
                            <h1 class="display-1 fw-bold text-primary"
                                ...
                                502</h1>
                            <h2 class="text-body-secondary fw-bolder mb-3">Bad Gateway!</h2>
                            <p class="text-body mb-5">Server yang bertindak sebagai gateway menerima respons yang tidak
                                valid dari server upstream.</p>
                            @php
