                    ...
                    <div class="row justify-content-center align-items-center g-5 text-center">
                        <div class="col-12" style="font-family: “Brush Script MT”, cursive;">
                            <h1 class="display-1 fw-bold text-primary"
                                ...
                                402</h1>
                            <h2 class="text-body-secondary fw-bolder mb-3">Pembayaran Diperlukan!</h2>
                            <p class="text-body mb-5">Permintaan ini memerlukan pembayaran untuk diproses. Silakan
                                lakukan pembayaran untuk melanjutkan.</p>
                            @php
