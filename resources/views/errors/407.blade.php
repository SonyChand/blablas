                    ...
                    <div class="row justify-content-center align-items-center g-5 text-center">
                        <div class="col-12" style="font-family: “Brush Script MT”, cursive;">
                            <h1 class="display-1 fw-bold text-primary"
                                ...
                                407</h1>
                            <h2 class="text-body-secondary fw-bolder mb-3">Autentikasi Proxy Diperlukan!</h2>
                            <p class="text-body mb-5">Anda perlu melakukan autentikasi dengan proxy untuk mengakses
                                halaman ini.</p>
                            @php
