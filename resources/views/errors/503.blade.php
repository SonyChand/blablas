                    ...
                    <div class="row justify-content-center align-items-center g-5 text-center">
                        <div class="col-12" style="font-family: “Brush Script MT”, cursive;">
                            <h1 class="display-1 fw-bold text-primary"
                                ...
                                503</h1>
                            <h2 class="text-body-secondary fw-bolder mb-3">Layanan Tidak Tersedia!</h2>
                            <p class="text-body mb-5">Server tidak dapat menangani permintaan karena sedang dalam
                                pemeliharaan atau kelebihan beban.</p>
                            @php
